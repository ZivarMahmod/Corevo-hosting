...
### 2026-06-02 (WORKFLOW-02 helsvep) — FAS 0 + FAS 0.5 + VÅG 0 KLAR (kod grön, EJ committat, EJ deployat)
...
- **NÄSTA:** Våg 1 parallellt (skilda revir): M2 storefront · M7 platform · M6 salon-admin. Inget committat/deployat än (väntar Zivars ja). Pending-owner oförändrat (SERVICE_ROLE_KEY, Stripe-test-nycklar).
