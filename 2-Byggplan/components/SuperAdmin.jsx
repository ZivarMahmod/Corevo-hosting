  ...
  return (
    <div style={{ borderRadius: 16, overflow: "hidden", border: "1px solid var(--c-line)", boxShadow: "var(--shadow-md)" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1.25fr 1fr", background: t.bg, minHeight: 280 }}>
        ...
        <div style={{ position: "relative", backgroundImage: "url(https://images.unsplash.com/photo-1521590832167-7bcbfaa6381f?w=800&q=80&auto=format&fit=crop)", backgroundSize: "cover", backgroundPosition: "center" }}>
