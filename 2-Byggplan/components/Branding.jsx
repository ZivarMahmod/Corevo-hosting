      ...
      <div style={{ display: "grid", gridTemplateColumns: "390px 1fr", gap: 20, alignItems: "start" }} className="bo-brand">
        ...
        <div>
          ...
          <div style={{ borderRadius: 18, overflow: "hidden", border: "1px solid var(--c-line)", boxShadow: "var(--shadow-md)" }}>
            ...
            <div style={{ position: "relative", height: 430, backgroundImage: "url(https://images.unsplash.com/photo-1521590832167-7bcbfaa6381f?w=1200&q=80&auto=format&fit=crop)", backgroundSize: "cover", backgroundPosition: "center" }}>
