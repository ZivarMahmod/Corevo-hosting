...
> **⚠️ STATUS-KORRIGERING 2026-06-17:** SHIPPED LIVE 2026-06-14 (3-dörrars admin-split, host-låsta cookies + door-isolated login, worker `1cb807ce`). Denna ligger fel i `goals/` — flytta till `2-Byggplan/klart/02-ytor/`. Ev. enda öppna rad: logged-in role-rejection-test (pending Zivar-test). Läs INTE som öppen plan.
