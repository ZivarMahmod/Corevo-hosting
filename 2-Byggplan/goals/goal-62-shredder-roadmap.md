...
- [x] **G1. Träffytorna** ✅ Mätt med RIKTIG inloggning över alla 12 admin-sidor: **11 knappar
      under 44px-golvet**. De minsta var de farligaste — "Ta bort bild" (26×26) och "Logga ut"
      (26×26). Alla lyfta till 44px med kvittad marginal (radhöjder oförändrade):
      rail-toggeln 30×30 · signout 26×26 · tema-segmenten 36×32 · klockan 38×38 · sökrutan 43px
      (EN pixel under) · vy-växlaren 34px · rowBtn 33×33 · status-pillen 91×28 · media
      radera/alt-text 26×26 · tjänsternas reglage 42×24 + redigera 25×25 · statusfiltren 40px ·
      admin-`.btn` 37px.
      **Lärdomen:** koden PÅSTOD "träffytan växer med raden" i en kommentar — men en `<button>`
      växer inte med sin rad, den är exakt så stor som sin box. Mätningen tog kål på antagandet.
      **Mätt efter: 0 knappar under 44px i hela kund-adminen.**
- [ ] **G2. Kebab-/kontextmenyer** — MÄTT: **0 kebab-menyer i kund-adminen** (super-admin har dem).
      Raderna bär i stället sina åtgärder som synliga ikon-knappar. Det är ett DESIGNVAL, inte en
      bugg → **fråga Zivar** om raderna ska få kebab (som super-admin) eller behålla synliga knappar.
- [ ] **G3. Toggle-utseendet** — MÄTT: **två olika on/off-uttryck** i adminen. Bloggen använder en
      text-pill ("Avpublicera", 95×44, radie 8) och tjänsterna en switch (44×44 träffyta, rundat
      spår). Butik och kurser har **ingen** publicera-kontroll alls i listvyn. → **fråga Zivar**:
      ETT uttryck (PillToggle) överallt, eller switch = "synlig" och pill = "publicerad"?
- [ ] **G4. Fil-drop-kort** — MÄTT: **0 `input[type=file]` i DOM:en** på /media; uppladdningen går
      via en dold kontroll bakom en knapp. Ett drop-kort är alltså nybygge, inte en omstylning.
- **Deploy-frysningen hävd (Zivar 2026-07-12): kund-admin får deployas när ändringen är verifierad.**
