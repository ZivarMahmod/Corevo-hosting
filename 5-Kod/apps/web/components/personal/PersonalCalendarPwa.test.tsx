...
import { PersonalCalendarPwa } from './PersonalCalendarPwa'
  ...
  it('traps focus, closes on Escape and restores the booking trigger', async () => {
    await act(async () => root.render(
      <PersonalCalendarPwa
        ...
        todayHref={null}
        bookings={[{
          id: 'booking-1', status: 'confirmed', startTs: '2026-08-03T08:00:00Z', endTs: '2026-08-03T09:00:00Z',
          priceCents: 50000, staffId: 'staff-1', serviceId: 'service-1', serviceName: 'Klippning', locationId: 'location-1',
          customerId: null, customerLabel: 'Testkund', note: null, timeZone: 'UTC', customerPrefs: [], customerNote: null,
        }]}
        staff={[]}
