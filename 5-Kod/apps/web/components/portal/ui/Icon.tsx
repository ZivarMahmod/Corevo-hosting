...
/**
 * Shared back-office icon set — Lucide-derived (https://lucide.dev), MIT.
 * Ported from the Corevo Booking design-system handoff (ui_kits/icons.jsx) into
 * the stack as a typed, dependency-free component (no lucide-react dep). Thin
 * 1.75 stroke, currentColor — so it inherits whatever colour its container sets
 * (forest on the sidebar, ink on cream, gold on KPI deltas). Used only by the
 * back-office primitives + chrome under [data-world="backoffice"].
 */
export type IconName =
  ...
  | 'message'
  | 'undo'
  // ── goal-48 onboarding-studio additions (additive — Lucide-derived, MIT) ──
  | 'rocket'
  | 'sliders'
  | 'globe'
  | 'grip'
...
const PATHS: Record<IconName, ReactElement> = {
  ...
  users: (
    <>
      ...
      <path d="M16 5a3.5 3.5 0 0 1 0 7M22 20a6.5 6.5 0 0 0-4-6" />
    </>
  ),
  scissors: (
    <>
  ...
  // ── goal-48 onboarding-studio additions (Lucide-derived, MIT) ──
  rocket: (
    <>
