...
//
// Stegsekvensen bor i lib/platform/onboarding-steps.ts (PURE + testad). Varje stegs JSX
// gatas på ETIKETTEN (ONBOARDING_STEPS[step]) — aldrig på ett hårdkodat index.
...
export function CreateTenantForm({ presets }: { presets: VerticalPresetData }) {
  // Stepper + footer-navigering är index-baserade; varje stegs JSX gatas på etiketten
  // STEPS[step], aldrig på ett hårdkodat index.
