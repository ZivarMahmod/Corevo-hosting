...
export const KallaPresentkort = (props: ThemePresentkortViewProps) => <PresentkortsKort {...props} spec={{ variant: 'kalla', titleFont: "'Marcellus'", titleSize: 52, titleColor: '#22302B', cardBg: '#1D5E54', cardRadius: 8, markColor: '#EDF2EC', accent: '#A9C4B8', muted: '#5F6B60', buttonBg: '#1D5E54', buttonColor: '#EDF2EC', body: '900 kr räcker till Källritualen — vår vanligaste gåva. Kortet skickas digitalt eller hämtas i ett kuvert av gräspapper.', cta: 'Lägg i varukorg' }} />
