...
const IMG = {
  stolarna: unsplashPhoto('1560066984-138dadb4c035', 1200), // heroens breda 4:3 (+ om-fotot i filens showOm)
  spegeln: unsplashPhoto('1488161628813-04466f872be2', 900), // heroens nedskjutna 3:4
  klippet: unsplashPhoto('1529139574466-a303027c1d8b', 900), // heroens högra 3:4
  studion: unsplashPhoto('1562322140-8baeececf3df', 1200), // om-sektionens 4:5 på hemmet
  galleri1: unsplashPhoto('1509631179647-0177331693ae', 900),
  galleri2: unsplashPhoto('1492106087820-71f1a00d2b11', 900),
  galleri3: unsplashPhoto('1531727991582-cfd25ce79613', 900),
  galleri4: unsplashPhoto('1539109136881-3be0616acf4b', 900),
} as const

/**
 * SNITT — svart studio (designpaketet).
 *
 ...
 */
export const snitt: StorefrontThemeDefinition = {
  key: 'snitt',
  name: 'Snitt',
  ...
  extraHome: [
    {
      name: 'pillar1Title',
      label: 'Prislistan på hemmet: rubrik',
      default: 'Hantverket, presenterat.',
    },
    {
      name: 'pillar1Body',
    ...
    // Galleri och Insidan använder designens ordagranna fallback.
    ...
    {
      name: 'clubNote',
      label: 'Insidan: kortets underrad',
      hint: 'T.ex. gata + stad. Visas bara om du fyller i den.',
      default: '',
    },
