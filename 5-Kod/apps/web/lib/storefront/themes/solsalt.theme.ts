...
const IMG = {
  sirocco: unsplashPhoto('1602934585418-f588bea4215c', 1200), // heroens foto i filen
  amalfi: unsplashPhoto('1490750967868-88aa4486c946', 1200), // filens om-foto (både hem-bandet och /om)
  oliv: unsplashPhoto('1563241527-3004b7be0ffd', 1200),
  solros: unsplashPhoto('1470509037663-253afd7f0f51', 1200),
  medelhav: unsplashPhoto('1598453055371-0f5e37113bea', 1200),
  bodensVal: unsplashPhoto('1522748906645-95d8adfd52c7', 1200),
} as const

/**
 * SOL & SALT — medelhavsbod (designpaketet).
 *
 ...
 */
export const solsalt: StorefrontThemeDefinition = {
  key: 'solsalt',
  name: 'Sol & Salt',
  ...
  content: {
    ...
    utility: 'Fri hemkörning över 400 kr · Färskt från grossisten varje morgon · Öppet alla dagar',
  ...
  extraHome: [
    ...
    { name: 'pillar1Title', label: 'Platta 1: rubrik', default: 'Hemkörning' },
    {
      ...
      label: 'Platta 1: text',
      rows: 2,
      default: 'Fri över 400 kr, samma dag.',
    },
    { name: 'pillar2Title', label: 'Platta 2: rubrik', default: 'Krukväxter' },
    {
      ...
      label: 'Platta 2: text',
      rows: 2,
      default: 'Grönt som tål en solig bräda.',
    },
    ...
    // Galleriet och Solklubben använder designens ordagranna fallback.
