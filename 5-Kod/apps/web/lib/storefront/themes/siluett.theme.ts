...
const IMG = {
  hero: unsplashPhoto('1509631179647-0177331693ae', 1200), // N°01 — klippning & form (heron i filen)
  salong: unsplashPhoto('1560066984-138dadb4c035', 1200), // "Ett magasin du kliver in i." (salongs-fotot)
  portratt: unsplashPhoto('1496747611176-843222e1e57c', 1200), // om-fotot i filen (även N°02 i arkivet)
  arkiv3: unsplashPhoto('1539109136881-3be0616acf4b', 1200), // N°03 — uppsättning
  arkiv4: unsplashPhoto('1503342217505-b0a15ec3261c', 1200), // N°04 — färg
  arkiv5: unsplashPhoto('1488161628813-04466f872be2', 1200), // N°05 — editorial
  arkiv6: unsplashPhoto('1529139574466-a303027c1d8b', 1200), // N°06 — klipp
} as const

/**
 * SILUETT — modemagasin (designpaketet).
 *
 ...
 */
export const siluett: StorefrontThemeDefinition = {
  key: 'siluett',
  name: 'Siluett',
  ...
  extraHome: [
    ...
    {
      name: 'pillar2Title',
      label: 'Hero: adressrad',
      default: 'Drottninggatan 4 · Stockholm · Tis–Lör',
    },
    {
      name: 'pillar3Title',
      label: 'Remsan (ord separerade med ·)',
      default: 'Klipp · Färg · Balayage · Uppsättning · Vård',
    },
    { name: 'homeGalleryEyebrow', label: 'Salongen: eyebrow', default: 'Salongen' },
    {
      name: 'shopEyebrow',
      label: 'Butiken: eyebrow',
      default: 'Det vi själva använder vid stolen',
    },
    ...
    // Arkivet och Första raden använder designens ordagranna fallback.
    ...
    {
      name: 'clubNote',
      label: 'Första raden: kortets underrad',
      hint: 'T.ex. salong + gata. Visas bara om du fyller i den.',
      default: '',
    },
