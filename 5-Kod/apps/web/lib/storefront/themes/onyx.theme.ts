...
const IMG = {
  magnoliaNoir: unsplashPhoto('1518343161123-c7e9ab4dc4da'), // FIG. 01 — hero i filen
  brandRosa: unsplashPhoto('1557982780-d68d843c32ab'), // FIG. 02 — om-fotot i filen
  glod: unsplashPhoto('1442458017215-285b83f65851'), // FIG. 03 — closing-fotot i filen
  vinmork: unsplashPhoto('1612351641432-20a0f196086c'), // FIG. 04
  askros: unsplashPhoto('1520179737749-b7752f6f56fb'), // FIG. 05
  calla: unsplashPhoto('1469259943454-aa100abba749'), // FIG. 06
} as const

/**
 * ONYX — mörk studio (designpaketet).
 *
 ...
 */
export const onyx: StorefrontThemeDefinition = {
  key: 'onyx',
  name: 'Onyx',
  ...
  ownsCopy: true,
  // Hemmets redigerbara element använder layoutens inbyggda
  // fallback-sträng VERBATIM (OnyxLayout/onyx.modules) — fältet ska förifyllas ärligt.
  extraHome: [
    {
      name: 'findEyebrow',
      label: 'Hero: fotnot',
      default: 'KVÄLLSLEVERANS 18–23 · BESTÄLL FÖRE 20:00',
    },
    {
      name: 'homeGalleryEyebrow',
      label: 'Hero: bildtext (FIG)',
      default: 'FIG. 01 — MAGNOLIA NOIR',
    },
    ...
    { name: 'pillar1Title', label: 'Väg 02: rubrik', default: 'Veckans drop' },
    {
      ...
      label: 'Väg 02: text',
      rows: 2,
      default: 'Begränsade buketter, nya varje måndag.',
    },
    { name: 'pillar2Title', label: 'Väg 03: rubrik', default: 'Night classes' },
    {
      ...
      label: 'Väg 03: text',
      rows: 2,
      default: 'Kvällskurser i studion — bind till hög musik.',
    },
    { name: 'pillar3Title', label: 'Väg 08: rubrik', default: 'Kretsen' },
    {
      ...
      label: 'Väg 08: text',
      rows: 2,
      default: 'Inre cirkeln. Tidig access och stängda kvällar.',
    },
    ...
    // Arkivet och Kretsen använder designens ordagranna fallback.
