...
const IMG = {
  spreadL: unsplashPhoto('1582794543139-8ac9cb0f7b11'), // uppslagets vänstra foto (620px)
  spreadR: unsplashPhoto('1454262041357-5d96f50a2f27'), // uppslagets högra foto (540px, 80px nedskjutet)
  tradgardsros: unsplashPhoto('1524835391568-32c8f7016d73', 900), // No. I — trädgårdsros
  vitCeremoni: unsplashPhoto('1522748906645-95d8adfd52c7', 900), // No. II — vit ceremoni
  sommarang: unsplashPhoto('1582874576091-26fa231ce87c', 900), // No. III — sommaräng
  aftonljus: unsplashPhoto('1598453055371-0f5e37113bea', 900), // No. IV — aftonljus
  stillaFarval: unsplashPhoto('1596309322315-da9e713cbb22', 900), // No. V — stilla farväl
  manadensVal: unsplashPhoto('1716982360804-b0bfdb28103e', 900), // No. VI — månadens val
  om: unsplashPhoto('1727520327526-4b435667860a'), // om-uppslagets foto
} as const

/**
 * ELORIA — klassiskt magasin (designpaketet).
 *
 ...
 */
export const eloria: StorefrontThemeDefinition = {
  key: 'eloria',
  name: 'Eloria',
  ...
  extraHome: [
    ...
    // Galleriet och brevet använder designens ordagranna fallback.
