...
const IMG = {
  hero: unsplashPhoto('1709983967470-f6c72b61cc62'), // heroens valv — "ur studion, bunden i morse"
  buketter: unsplashPhoto('1747226757815-d827b3aa4c5a', 900), // paths[0] — Buketter
  brollop: unsplashPhoto('1522748906645-95d8adfd52c7', 900), // paths[1] — Bröllop
  kurser: unsplashPhoto('1487530811176-3780de880c2d', 900), // paths[2] — Kurser & event
  studion: unsplashPhoto('1746929015083-b313a9cb7dff'), // showOm + hemmets "Studion"-valv
  angsbrev: unsplashPhoto('1602934585418-f588bea4215c', 900), // rawProducts p3
  solvarm: unsplashPhoto('1628456676381-cf822e3c3f9f', 900), // rawProducts p4
  closing: unsplashPhoto('1711638753941-3a7128aa759f'), // avslutningens helbreddsfoto
  florister: unsplashPhoto('1494790108377-be9c29b29330', 700), // team[0]
  buketterna: unsplashPhoto('1500648767791-00dcc994a43e', 700), // team[1]
  radgivning: unsplashPhoto('1438761681033-6461ffad8d80', 700), // team[2]
} as const

/**
 * AURORA — romantisk studio (designpaketet).
 *
 ...
 */
export const aurora: StorefrontThemeDefinition = {
  key: 'aurora',
  name: 'Aurora',
  ...
  content: {
    ...
    servicesIntro: 'Små grupper, mycket blommor och fika i studion. Alla nivåer är välkomna.',
    teamEyebrow: 'Studion',
    ...
    galleryImages: [IMG.buketter, IMG.brollop, IMG.kurser, IMG.solvarm, IMG.angsbrev, IMG.studion],
  ...
  extraHome: [
    ...
    { name: 'clubTitle', label: 'Klubben: rubrik', default: 'Var nionde bukett bjuder vi på' },
    {
      ...
      default:
        'Gratis att gå med. Varje bukett ger en stämpel — den nionde väljer du fritt ur sortimentet.',
    },
