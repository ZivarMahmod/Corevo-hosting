 ...
 * verifierade statiska sidan i public/mallar/zentum/ (index.html + style.css = kanon).
 * Overlay-header över 950px-hero,
 ...
 */
export const zentum: StorefrontThemeDefinition = {
  key: 'zentum',
  name: 'Zentum',
