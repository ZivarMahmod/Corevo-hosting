...
import { themeOrderPrefix } from '@/lib/storefront/themes/registry'
...
//
// goal-60: skalet + kontoerbjudandet bär nu order-confirmation.module.css (var 3 inline
// style={{}}). Gaten och auth-logiken är oförändrade.
