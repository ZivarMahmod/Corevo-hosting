...
**Bygg istället:**
- "Boka tid" öppnar bokningen in-page — inline-sektion, tab eller slide-over-drawer inom storefronten. Samma header/brand syns hela tiden.
- Samma logiska steg som Wavy (tjänst → personal → dag/tid → uppgifter → bekräftelse) men i salongens designspråk, snyggt och tydligt — lediga tider som fina tidschips, inte gråa rader.
- Studera `book.wavy.nu` live BARA för flödes-logiken; designen ska vara storefront-klass, inte Wavy-klass.
- Bekräftelse (kvitto-känsla) sker också in-page. Kunden ska aldrig se en främmande domän/portal.
