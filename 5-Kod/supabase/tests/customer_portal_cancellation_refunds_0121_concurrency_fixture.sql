...
insert into public.bookings (
  ...
  ('c1210000-0000-4000-8000-000000000074','c1210000-0000-4000-8000-000000000001','c1210000-0000-4000-8000-000000000041','c1210000-0000-4000-8000-000000000051','c1210000-0000-4000-8000-000000000061','c1210000-0000-4000-8000-000000000021','c1210000-0000-4000-8000-000000000031',statement_timestamp()+interval '36 days',statement_timestamp()+interval '36 days 30 minutes','confirmed',10000),
...
insert into public.payments (
  ...
  ('c1210000-0000-4000-8000-000000000095','c1210000-0000-4000-8000-000000000001','c1210000-0000-4000-8000-000000000074',10000,'sek','succeeded','pi_concurrency_cancel_owner','acct_concurrency_0121');
insert into private.payment_refund_jobs (
  id,tenant_id,payment_id,booking_id,provider,provider_payment_intent_id,
  provider_connected_account_id,provider_idempotency_key
) values
  ('c1210000-0000-4000-8000-000000000101','c1210000-0000-4000-8000-000000000001','c1210000-0000-4000-8000-000000000081','c1210000-0000-4000-8000-000000000071','stripe','pi_concurrency_job_1','acct_concurrency_0121','refund_c1210000-0000-4000-8000-000000000071'),
  ('c1210000-0000-4000-8000-000000000102','c1210000-0000-4000-8000-000000000001','c1210000-0000-4000-8000-000000000082','c1210000-0000-4000-8000-000000000072','stripe','pi_concurrency_job_2','acct_concurrency_0121','refund_c1210000-0000-4000-8000-000000000072');
