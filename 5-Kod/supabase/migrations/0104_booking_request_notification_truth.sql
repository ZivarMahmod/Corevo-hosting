-- 0104 — a pending storefront request must never masquerade as a confirmed booking.
-- Replaces the 0100 router so received requests and final confirmations have separate
-- durable identities. Business mutations still never call a provider; they record one event;
