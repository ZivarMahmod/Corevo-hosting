...
function BackOffice() {
  const [role, setRole] = useStateApp("super");
  const [section, setSection] = useStateApp("Översikt");
  ...
  const firstOf = { super: "Översikt", salon: "Dashboard", staff: "Idag", customer: "Mina sidor" };
  ...
  return (
    <StoreProvider>
      <RoleSwitcher role={role} onRole={setRoleReset} />
      {role === "customer" ? (
