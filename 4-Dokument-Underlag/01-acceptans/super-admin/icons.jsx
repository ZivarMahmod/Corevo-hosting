...
const Icon = ({ name, size = 20, stroke = 1.75, style = {}, className = "" }) => {
  const P = {
    ...
    rocket: <><path d="M4.5 16.5c-1.5 1.3-2 5-2 5s3.7-.5 5-2c.7-.8.7-2 0-2.8a2 2 0 0 0-3 0Z"/><path d="M12 15l-3-3a16 16 0 0 1 8-9 9 9 0 0 1 4 4 16 16 0 0 1-9 8Z"/><path d="M9 12H4s.5-2.8 2-4 5 0 5 0M12 15v5s2.8-.5 4-2 0-5 0-5"/></>,
