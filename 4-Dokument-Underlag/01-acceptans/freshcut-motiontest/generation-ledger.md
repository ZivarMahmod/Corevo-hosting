...
Status: pre-generation gate passed; generation active; seven S0 attempts rejected
Balance last verified after job 01R6: 895.5 credits (2026-08-10)
...
- seven documented S0 composition retries: +14 credits; current projected path
  272 credits, expected final balance 637.5 credits and unchanged compliance with
  all gates;
- retry-expanded headroom to the 60% ceiling: 273.7 credits.
...
| Rights/budget, additional safety review | GO | v2 prompts, rows, sequential allowlist and reproducible still chain required | mechanical rereview confirmed the 22-job / 258-credit baseline; the documented retry-expanded ledger now has 29 submissions / 272 credits; live checks remain per job | pass |
...
| 01R7 | S0 depth/vertical retry / SALON_REF / K0 | Nano Banana Pro, 2K, 16:9 | none; retry of 01R6 | 2 | 0 | — | planned after documented vertical-safe failure | no |
