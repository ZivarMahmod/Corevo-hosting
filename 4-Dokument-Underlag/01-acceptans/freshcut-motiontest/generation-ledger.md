...
Status: pre-generation gate passed; generation active; four S0 attempts rejected
Balance last verified after job 01R3: 901.5 credits (2026-08-10)
...
- four documented S0 composition retries: +8 credits; current projected path
  266 credits, expected final balance 643.5 credits and unchanged compliance with
  all gates;
- retry-expanded headroom to the 60% ceiling: 279.7 credits.
...
| Rights/budget, additional safety review | GO | v2 prompts, rows, sequential allowlist and reproducible still chain required | mechanical rereview confirmed the 22-job / 258-credit baseline; the documented retry-expanded ledger now has 26 submissions / 266 credits; live checks remain per job | pass |
...
| 01R4 | S0 fourth retry / SALON_REF / K0 | Nano Banana Pro, 2K, 16:9 | none; retry of 01R3 | 2 | 0 | — | planned after documented DOM-overlay failure | no |
